...
public class FollowingViewModel extends ViewModel {
    private final MutableLiveData<ArrayList<User>> listFollowingFromApi = new MutableLiveData<>();
    private User user;
    ...
    public LiveData<ArrayList<User>> getListFollowerFromApi(){
        return listFollowingFromApi;
    }

    public void setFollowingFromApi(String username){
        ...
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    listFollowingFromApi.postValue(list);
